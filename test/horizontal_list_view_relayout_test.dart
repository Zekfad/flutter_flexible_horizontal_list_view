...
void main() {
  testWidgets(
    'Underflowing HorizontalListView should relayout for additional children',
  ...
  testWidgets(
    'Underflowing HorizontalListView contentExtent should track additional children',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        Directionality(
          textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'Overflowing HorizontalListView should relayout for missing children',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        Directionality(
          textDirection: TextDirection.ltr,
  ...
  testWidgets(
    'Overflowing HorizontalListView should not relayout for additional children',
    (WidgetTester tester) async {
      await tester.pumpWidget(
        Directionality(
          textDirection: TextDirection.ltr,
  ...
  testWidgets('Overflowing HorizontalListView should become scrollable', (
    WidgetTester tester,
  ) async {
    ...
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
        child: HorizontalListView(
          children: const <Widget>[SizedBox(width: 100.0, child: Text('100'))],
        ),
      ),
    );
