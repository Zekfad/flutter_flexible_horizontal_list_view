...
void main() {
  testWidgets('HorizontalListView can handle shrinking top elements', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets(
    'HorizontalListView can handle shrinking top elements with cache extent',
  ...
  testWidgets('HorizontalListView can handle inserts at 0', (
    WidgetTester tester,
  ) async {
    final ScrollController controller = ScrollController();
    addTearDown(controller.dispose);
